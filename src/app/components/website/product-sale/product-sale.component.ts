...
export class ProductSaleComponent implements OnInit, OnDestroy {
        ...
        this.route.paramMap.subscribe(params => {
            ...
            if (id) {
                try {
                    ...
                    console.warn('Could not decrypt productId', e);
                }
                this.productId = id;
                this.loadProduct();
                this.loadReviews();
    ...
    loadReviews() {
        this.reviewService.getTop30Reviews({ productId: Number(this.productId) }).subscribe({
            next: (data) => {
                this.reviews = data;
            },
    ...
    submitReview() {
        ...
        this.newReview.productId = Number(this.productId) || 0;
        this.newReview.courseId = 0;
        this.newReview.bundleId = 0;

        console.log('[ProductSale] Submitting review payload:', this.newReview);
